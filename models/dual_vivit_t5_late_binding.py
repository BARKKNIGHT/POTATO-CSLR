class ViViT_SLR(nn.Module):
    def __init__(self,
        ...
        self.early_norm_kp_to_normal_1 = nn.LayerNorm(768, eps=1e-6)
        self.early_norm_kp_to_normal_2 = nn.LayerNorm(768, eps=1e-6)
        self.early_norm_normal_to_kp_1 = nn.LayerNorm(768, eps=1e-6)
        self.early_norm_normal_to_kp_2 = nn.LayerNorm(768, eps=1e-6)

        self.mid_norm_kp_to_normal_1 = nn.LayerNorm(768, eps=1e-6)
        self.mid_norm_kp_to_normal_2 = nn.LayerNorm(768, eps=1e-6)
        self.mid_norm_normal_to_kp_1 = nn.LayerNorm(768, eps=1e-6)
        self.mid_norm_normal_to_kp_2 = nn.LayerNorm(768, eps=1e-6)
    ...
    def forward(self, normal_vid, keypoint_vid, y_tokens):
        ...
        for i in range(12):
            ...
            if i == self.early_attention:
                normal_encoded_output = self.early_norm_normal_to_kp_1(normal_encoded_output)
                keypoint_encoded_output = self.early_norm_kp_to_normal_1(keypoint_encoded_output)
                ...
                normal_encoded_output = self.early_norm_normal_to_kp_2(normal_encoded_output + early_normal_to_kp)
                keypoint_encoded_output = self.early_norm_kp_to_normal_2(keypoint_encoded_output + early_kp_to_normal)

            elif i == self.mid_attention:
                normal_encoded_output = self.mid_norm_normal_to_kp_1(normal_encoded_output)
                keypoint_encoded_output = self.mid_norm_kp_to_normal_1(keypoint_encoded_output)
                ...
                normal_encoded_output = self.mid_norm_normal_to_kp_2(normal_encoded_output + mid_normal_to_kp)
                keypoint_encoded_output = self.mid_norm_kp_to_normal_2(keypoint_encoded_output + mid_kp_to_normal)
        ...
        normal_decoded_output = self.t5_normal.decoder(input_ids=y_tokens, encoder_hidden_states=normal_encoded_output, attention_mask=decoder_attention_mask).last_hidden_state
        keypoint_decoded_output = self.t5_keypoint.decoder(input_ids=y_tokens, encoder_hidden_states=keypoint_encoded_output, attention_mask=decoder_attention_mask).last_hidden_state
